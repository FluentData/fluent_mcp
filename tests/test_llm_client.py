...
from fluent_mcp.core.llm_client import LLMClientError, LLMClientNotConfiguredError, configure_llm_client, get_llm_client
...
def test_ollama_config():
    ...
    invalid_config = {"provider": "ollama", "model": "llama2", "api_key": "ollama"}
...
def test_groq_config():
    ...
    invalid_config = {"provider": "groq", "model": "llama2-70b-4096"}
...
def test_unsupported_provider():
    ...
    config = {"provider": "unsupported", "model": "model", "api_key": "api_key"}
