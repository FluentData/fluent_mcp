...
def main():
    ...
    # Find all test files
    test_files = [f for f in os.listdir(script_dir) if f.startswith("test_") and f.endswith(".py") and f != os.path.basename(__file__)]
    ...
    for test_file in test_files:
        ...
        result = subprocess.run([sys.executable, os.path.join(script_dir, test_file)], capture_output=True, text=True)
